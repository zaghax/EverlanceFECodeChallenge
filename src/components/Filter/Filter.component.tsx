...
const Filter = () => {
  ...
  return (
    <form onSubmit={filterHandler} className='border-gray-200 border-solid border p-1 mr-2 flex items-center'>
      <input type='text' onChange={setFilterValue} placeholder='Enter userame or email' className='outline-none'/>
      <button type='submit'>
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' width='25px' height='25px' className='opacity-50'>
